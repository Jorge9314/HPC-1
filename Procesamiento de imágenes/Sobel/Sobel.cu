...
__host__
void convolution(unsigned char *imagen, int mascara[3][3], int filas, int columnas, unsigned char *resultado){
...
__global__
void convolutionCU(unsigned char *imagen, int *mascara, int filas, int columnas, unsigned char *resultado){
...
__global__
void UnionCU(unsigned char *img_resultado, unsigned char *resultado_Gx, unsigned char *resultado_Gy, int filas, int columnas){
...
int main(int argc, char **argv){
    ...
    unsigned char *d_Gx, *d_Gy, *h_Gx, *h_Gy, *h_G, *d_G; // Sobel Operators
    int *d_XMask, *d_YMask;
    ...
    //waitKey(0);
    imwrite("Gray image CUDA", result_imageGray);
    ...
    //waitKey(0);
    imwrite("Sobel CUDA", result_Sobel);
